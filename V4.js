...
if (!音韻地位) return [
 ['小舌化聲母形式', [2, 'ᵱ/q', 'p̙/k̙']],
 ['二等記號', [1, '捲舌符號 ◌˞', '咽化符號 ◌ˤ']],
 ['通江宕攝韻尾', [1, '默認', 'ŋʷ/kʷ', 'ŋ/k']], //“默認”的意思就是在“小舌化聲母形式”裡面選的內容
 ['聲調記號', [1, '五度記號', 'ˀ/ʰ', '無']],
];
...
function get韻母() {
  ...
  const 推導韻到元音 = [
    ...
    ['麻銜刪　庚肴　','a'],
    ['脂侵真　　幽　','i'],
    ['之　殷　蒸尤微','ɯ'], //实际上应当更靠前（如ɨ），但是我看不清楚，眼睛有问题
    ['侯　文東　　　','u'],
    ['　覃　　　　咍','ʌ'],
    ['佳咸山　耕　皆','ɛ'],
    ['　添先　青蕭齊','e'],
    ...
    ['　嚴元　　　　','ɯʌ'],
    ['　　臻　　　　','ɯi'], 
  ]; //如果有明显的高化/前化的三等元音，msoeg认为可以加一个高介音
  ...
  韻尾 = 韻尾.replace('k̙','q').replace('ŋ̙','ɴ')};
   ...
   韻尾 = 韻尾.replace(元音.slice(-1), ''); //删去重复的内容（但是好像两个是一样的？）
   if (is('二等 非 知莊組')){
	if (is('麻銜刪庚肴韻') &&字頭 !== '打'){
	  元音 = 元音.replace('a','a˞');
	}
    ...
    if (is('之殷蒸尤微陽臻韻')){
	  元音 = 元音.replace('ɯ','ɯ˞'); //逆天，但是强迫症还是写上
	}
    if (is('佳咸山耕皆韻')){
	  元音 = 元音.replace('ɛ','ɛ˞');
	}
