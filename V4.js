...
function get韻母() {
  ...
  } else if (is('合口 非 云母 非 侯文東模魂冬灰凡廢虞鍾韻')) {
    元音 = 'w' + 元音; 
    }
 ...
 if (選項.江韻韻腹 == 'œ') {元音 = 元音.replace('ɞ','œ')}; if (選項.江韻韻腹 == 'ɔ') {元音 = 元音.replace('ɞ','ɔ')};
 if (選項.魂韻和灰韻韻腹 == '魂韻ɤ 灰韻ʌ') {if (is ('魂韻')) {元音 = 元音.replace('o','wɤ')};
  if (is('灰韻')) {元音 = 元音.replace('o','wʌ')}}
